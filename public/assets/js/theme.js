...
var theme = {
  ...
  */
  ...
  offCanvas: () => {
    ...
    // Prefer the centralized shared offcanvas by id, fall back to any .offcanvas-nav
    const navOffCanvas = document.getElementById('navbarOffcanvas') || document.querySelector('.offcanvas-nav');
    // If there's no offcanvas on the page, skip init
